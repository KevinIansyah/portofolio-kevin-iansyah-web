...
<template>
  <section class="mx-auto py-18 px-4 md:max-w-6xl">
    <div class="px-4 lg:px-6 py-18 rounded-md bg-muted space-y-10">
      ...
      <div class="flex w-full justify-center">
        <Button variant="project">
          <router-link to="#" class="flex gap-2 text-sm items-center">Lihat Semua Proyek <ArrowRight class="size-4" /></router-link>
        </Button>
      </div>
    </div>
  </section>

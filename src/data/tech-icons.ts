...
export const techIcons: TechIcon[] = [
  ...
  { id: 'postgresql', name: 'PostgreSQL', dark: postgresqlDark, light: postgresqlLight },
  { id: 'vue', name: 'Vue.js', dark: vueDark, light: vueLight },
  { id: 'react', name: 'React', dark: reactDark, light: reactLight },
  { id: 'typescript', name: 'TypeScript', dark: typescriptDark, light: typescriptLight },
  { id: 'javascript', name: 'JavaScript', dark: javascriptDark, light: javascriptLight },
  ...
  { id: 'bootstrap', name: 'Bootstrap', dark: bootstrapDark, light: bootstrapLight },
  { id: 'tailwind', name: 'Tailwind CSS', dark: tailwindDark, light: tailwindLight },
